...
const MainBanner = () => {
  return (
    <>
      <div className="hidden lg:block bg-cover bg-center bg-no-repeat h-[80vh] rounded-xl bg-[url('@/shared/assets/main-banner-bg.png')]">
        <div className="flex flex-col justify-center w-[45%] h-full text-white float-right p-4">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4 mt-16 p-6 bg-[#fff3] rounded-xl w-[85%]">
            ...
            <div className="flex flex-col items-center gap-2.5">
              <div className="flex">
                {Array.from({ length: 5 }).map((_, index) => (
                  <Star key={index} fill="#ffd70a" stroke="#ffd70a" size={22} />
                ))}
              </div>
